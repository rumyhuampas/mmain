					...
					if(Helpers_Utils::strContains($userobj->Profile, Helpers_Const::UPADMIN)){
						echo Form::open('abmusers/editprofiles', array('method' => 'POST', 'class' => 'stdform', 'id' => 'formeditprofiles'));
							echo '<p>';
								...
								if(Helpers_Utils::strContains($userobj->Profile, Helpers_Const::UPVENTA)){
								...
								if(Helpers_Utils::strContains($userobj->Profile, Helpers_Const::UPGRANJA)){
								...
								if(Helpers_Utils::strContains($userobj->Profile, Helpers_Const::UPESTADISTICO)){
